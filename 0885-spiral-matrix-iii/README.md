<h2><a href="https://leetcode.com/problems/spiral-matrix-iii/description/">885. Spiral Matrix III</a></h2><h3>Medium</h3><hr><p>You start at the cell <code>(rStart, cStart)</code> of an <code>rows x cols</code> grid facing east. The northwest corner is at the first row and column in the grid, and the southeast corner is at the last row and column.</p>
